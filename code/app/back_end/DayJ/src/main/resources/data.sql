...
insert into plan (id, user_id, is_complete, plan_alarm_date, plan_create_date, plan_tag, goal, plan_photo, plan_time, plan_day) values (1, 1, false, '2023-01-14', '2023-01-14', 'Nissan', 'Chevrolet', 'Volvo', '2023-01-14', '2023-01-14');
insert into plan (id, user_id, is_complete, plan_alarm_date, plan_create_date, plan_tag, goal, plan_photo, plan_time, plan_day) values (2, 1, true, '2023-01-14', '2023-01-14', 'Lexus', 'Toyota', 'Infiniti', '2023-01-14', '2023-01-14');
